...
원천/가공 스키마에는 1등뿐 아니라 2등, 3등의 회차별 실당첨금과 당첨자 수도 포함됩니다.
...
수집 필드:
- 기본 당첨 정보: 회차, 날짜, 당첨번호 6개, 보너스
- 판매/1등 정보: 총판매액, 1등 실당첨금, 1등 당첨자 수, 1등 총액
- 추가 등수 정보: 2등 실당첨금, 2등 당첨자 수, 3등 실당첨금, 3등 당첨자 수
...
참고:
- 1등/2등/3등 당첨금은 데이터셋의 실제 회차별 금액을 우선 사용합니다.
- 4등/5등은 고정 당첨금 규칙을 사용합니다.
